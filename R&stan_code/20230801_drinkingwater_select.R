Data_drinking_water <- read.csv("20230801_drinking.csv")
...
#GDP per capital
Data_GDP <- select(Data_drinking_water, Country, BC_2000, SC_2000, BC_2020, SC_2020, GDPcapital2000, GDPcapital2020, Dummy0, Dummy1)
Data_GDP <- Data_GDP %>% drop_na()
Data_GDP <- Data_GDP %>% mutate(coverage_2000 = BC_2000 + SC_2000, coverage_2020 = BC_2020 + SC_2020)

Data_GDP_2000 <- select(Data_GDP, Country, coverage_2000, GDPcapital2000, Dummy0)
colnames(Data_GDP_2000) <- c("country", "coverage", "GDPcapital", "Dummy") 

Data_GDP_2020 <- select(Data_GDP, Country, coverage_2020, GDPcapital2020, Dummy1)
...
ggsave(path = NULL, file = "GDP_drinking_20230801.svg", plot = plot, dpi = 600, width = 4, height = 3.2)
...
#Net ODA
Data_ODA <- select(Data_drinking_water, Country, Coverage2000, Coverage2020, NetODA2020, NetODA2000, Dummy0, Dummy1)

Data_ODA_2000 <- select(Data_ODA, Country, Coverage2000, NetODA2000, Dummy0)
colnames(Data_ODA_2000) <- c("country", "coverage", "ODA", "Dummy") 

Data_ODA_2020 <- select(Data_ODA, Country, Coverage2020, NetODA2020, Dummy1)
...
#urbanization rate
Data_UP <- select(Data_drinking_water, Country, BC_2000, SC_2000, BC_2020, SC_2020, UP2000, UP2020, Dummy0, Dummy1)
Data_UP <- Data_UP %>% drop_na()
Data_UP <- Data_UP %>% mutate(coverage_2000 = BC_2000 + SC_2000, coverage_2020 = BC_2020 + SC_2020)

Data_UP_2000 <- select(Data_UP, Country, coverage_2000, UP2000, Dummy0)
colnames(Data_UP_2000) <- c("country", "coverage", "UP", "Dummy") 

Data_UP_2020 <- select(Data_UP, Country, coverage_2020, UP2020, Dummy1)
...
ggsave(path = NULL, file = "UP_drinking_20230801.svg", plot = plot_UP, dpi = 600, width = 4, height = 3.2)
...
#demogracy index
Data_di <- select(Data_drinking_water, Country, BC_2000, SC_2000, BC_2020, SC_2020, DI2006, DI2020, Dummy0, Dummy1)
Data_di <- Data_di %>% drop_na()
Data_di <- Data_di %>% mutate(coverage_2000 = BC_2000 + SC_2000, coverage_2020 = BC_2020 + SC_2020)

Data_di_2000 <- select(Data_di, Country, coverage_2000, DI2006, Dummy0)
colnames(Data_di_2000) <- c("country", "coverage", "di", "Dummy") 

Data_di_2020 <- select(Data_di, Country, coverage_2020, DI2020, Dummy1)
...
ggsave(path = NULL, file = "di_drinking_20230801.svg", plot = plot_di, dpi = 600, width = 4, height = 3.2)


ggsave(file = "di_drinking_202306.svg", plot = plot_di, width = 10, height = 8)
...
Data_RW <- select(Data_drinking_water, Country, BC_2000, SC_2000, BC_2020, SC_2020, RW2000, RW2020, Dummy0, Dummy1)
Data_RW <- Data_RW %>% drop_na()
Data_RW <- Data_RW %>% mutate(coverage_2000 = BC_2000 + SC_2000, coverage_2020 = BC_2020 + SC_2020)

Data_RW_2000 <- select(Data_RW, Country, coverage_2000, RW2000, Dummy0)
colnames(Data_RW_2000) <- c("country", "coverage", "RW", "Dummy") 

Data_RW_2020 <- select(Data_RW, Country, coverage_2020, RW2020, Dummy1)
...
ggsave(path = NULL, file = "RW_drinking_20230801.svg", plot = plot_RW, dpi = 600, width = 4, height = 3.2)
