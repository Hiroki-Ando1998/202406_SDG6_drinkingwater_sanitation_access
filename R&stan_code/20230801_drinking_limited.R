...
#GDP per capital
Data_GDP <- select(Data_drinking_water, Country, LC_2000, LC_2020, GDPcapital2000, GDPcapital2020, Dummy0, Dummy1)
...
ggsave(path = NULL, file = "GDP_drinking_limited_20230801.svg", plot = plot, dpi = 600, width = 4, height = 3.2)
...
#urbanization rate
Data_UP <- select(Data_drinking_water, Country, LC_2000, LC_2020, UP2000, UP2020, Dummy0, Dummy1)
...
ggsave(path = NULL, file = "UP_drinking_limited_20230801.svg", plot = plot_UP, dpi = 600, width = 4, height = 3.2)
...
data_list_UP_2 <- list(main = Data_UP$UP/100, centrailzedmain = Data_UP$UP - meanUP, dummy = Data_UP$Dummy, coverage = Data_UP$coverage/100, n = sample_size_UP)
mcmc_UP_2 <- stan(
  file = "20230707.stan",
  data = data_list_UP_2,
  seed = 1,
...
#demogracy index
Data_di <- select(Data_drinking_water, Country, LC_2000, LC_2020, DI2006, DI2020, Dummy0, Dummy1)
...
ggsave(path = NULL, file = "di_drinking_limited_20230801.svg", plot = plot_di, dpi = 600, width = 4, height = 3.2)
...
Data_RW <- select(Data_drinking_water, Country, LC_2000, LC_2020, RW2000, RW2020, Dummy0, Dummy1)
...
ggsave(path = NULL, file = "RW_drinking_limited_20230801.svg", plot = plot_RW, dpi = 600, width = 4, height = 3.2)
