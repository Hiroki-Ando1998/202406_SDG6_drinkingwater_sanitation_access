...
Data_drinking <- select(Data_drinking, Country, SC_2000, SC_2020,
                        GDPcapital2000, GDPcapital2020, UP2000, UP2020, DI2006, DI2020, Dummy0, Dummy1)
Data_drinking <- Data_drinking %>% drop_na()
...
#(c)drinking (limited)
Data_drinking <- read.csv("20230801_drinking_safety_basic_separted.csv")
Data_drinking <- select(Data_drinking, Country, LC_2000, LC_2020,
                        GDPcapital2000, GDPcapital2020, UP2000, UP2020, DI2006, DI2020, Dummy0, Dummy1)
Data_drinking <- Data_drinking %>% drop_na()
...
Data_sanitation <- select(Data_sanitation, Country, SC_2000, SC_2020,
                        GDPcapital2000, GDPcapital2020, UP2000, UP2020, DI2006, DI2020, Dummy0, Dummy1)
Data_sanitation <- Data_sanitation %>% drop_na()
...
#drinking (limited)
Data_sanitation <- read.csv("20230801_sanitation_safety_basic_seprarted.csv")
Data_sanitation <- select(Data_sanitation, Country, LC_2000, LC_2020,
                        GDPcapital2000, GDPcapital2020, UP2000, UP2020, ,DI2006, DI2020, Dummy0, Dummy1)
Data_sanitation <- Data_sanitation %>% drop_na()
