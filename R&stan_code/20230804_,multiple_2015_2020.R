...
Data_drinking <- select(Data_drinking, Country, BC_2015, SC_2015, BC_2020, SC_2020,
                        GDPcapital2015, GDPcapital2020, UP2015, UP2020, DI2015, DI2020, Dummy0, Dummy1)
Data_drinking <- Data_drinking %>% drop_na()
Data_drinking <- Data_drinking %>% mutate(coverage1 = BC_2015 + SC_2015, coverage2 = BC_2020 + SC_2020)

Data_drinking_2000 <- select(Data_drinking, Country, coverage1, GDPcapital2015, UP2015, DI2015, Dummy0)
colnames(Data_drinking_2000) <- c("country", "coverage", "GDPcapital", "UP", "di", "Dummy") 

Data_drinking_2020 <- select(Data_drinking, Country, coverage2, GDPcapital2020, UP2020, DI2020, Dummy1)
...
Data_drinking <- select(Data_drinking, Country, SC_2015, SC_2020,
                        GDPcapital2015, GDPcapital2020, UP2015, UP2020, DI2015, DI2020, Dummy0, Dummy1)
Data_drinking <- Data_drinking %>% drop_na()
Data_drinking_2000 <- select(Data_drinking, Country, SC_2015, GDPcapital2015, UP2015, DI2015, Dummy0)
colnames(Data_drinking_2000) <- c("country", "coverage", "GDPcapital", "UP", "di", "Dummy") 
...
#(c)drinking (limited)
Data_drinking <- read.csv("20230801_drinking_safety_basic_separted.csv")
Data_drinking <- select(Data_drinking, Country, LC_2015, LC_2020,
                        GDPcapital2015, GDPcapital2020, UP2015, UP2020, DI2015, DI2020, Dummy0, Dummy1)
Data_drinking <- Data_drinking %>% drop_na()
Data_drinking_2000 <- select(Data_drinking, Country, LC_2015, GDPcapital2015, UP2015, DI2015, Dummy0)
colnames(Data_drinking_2000) <- c("country", "coverage", "GDPcapital", "UP", "di", "Dummy") 

Data_drinking_2020 <- select(Data_drinking, Country, LC_2020, GDPcapital2020, UP2020, DI2020, Dummy1)
colnames(Data_drinking_2020) <- c("country", "coverage", "GDPcapital", "UP", "di", "Dummy") 
Data_drinking <- rbind(Data_drinking_2000, Data_drinking_2020)
...
Data_sanitation <- select(Data_sanitation, Country, BC_2015, SC_2015, BC_2020, SC_2020,
                          GDPcapital2015, GDPcapital2020, UP2015, UP2020, DI2015, DI2020, Dummy0, Dummy1)
Data_sanitation <- Data_sanitation %>% drop_na()
Data_sanitation <- Data_sanitation %>% mutate(coverage1 = BC_2015 + SC_2015, coverage2 = BC_2020 + SC_2020)

Data_sanitation_2000 <- select(Data_sanitation, Country, coverage1, GDPcapital2015, UP2015, DI2015, Dummy0)
colnames(Data_sanitation_2000) <- c("country", "coverage", "GDPcapital", "UP", "di", "Dummy") 

Data_sanitation_2020 <- select(Data_sanitation, Country, coverage2, GDPcapital2020, UP2020, DI2020, Dummy1)
...
Data_sanitation <- select(Data_sanitation, Country, SC_2015, SC_2020,
                          GDPcapital2015, GDPcapital2020, UP2015, UP2020, DI2015, DI2020, Dummy0, Dummy1)
Data_sanitation <- Data_sanitation %>% drop_na()
Data_sanitation_2000 <- select(Data_sanitation, Country, SC_2015, GDPcapital2015, UP2015, DI2015, Dummy0)
colnames(Data_sanitation_2000) <- c("country", "coverage", "GDPcapital", "UP", "di", "Dummy") 

Data_sanitation_2020 <- select(Data_sanitation, Country, SC_2020, GDPcapital2020, UP2020, DI2020, Dummy1)
colnames(Data_sanitation_2020) <- c("country", "coverage", "GDPcapital", "UP", "di", "Dummy") 
Data_sanitation <- rbind(Data_sanitation_2000, Data_sanitation_2020)

#drinking (limited)
Data_sanitation <- read.csv("20230801_sanitation_safety_basic_seprarted.csv")
Data_sanitation <- select(Data_sanitation, Country, LC_2015, LC_2020,
                          GDPcapital2015, GDPcapital2020, UP2015, UP2020 ,DI2015, DI2020, Dummy0, Dummy1)
Data_sanitation <- Data_sanitation %>% drop_na()
Data_sanitation_2000 <- select(Data_sanitation, Country, LC_2015, GDPcapital2015, UP2015, DI2015, Dummy0)
colnames(Data_sanitation_2000) <- c("country", "coverage", "GDPcapital", "UP", "di", "Dummy") 

Data_sanitation_2020 <- select(Data_sanitation, Country, LC_2020, GDPcapital2020, UP2020, DI2020, Dummy1)
colnames(Data_sanitation_2020) <- c("country", "coverage", "GDPcapital", "UP", "di", "Dummy") 
Data_sanitation <- rbind(Data_sanitation_2000, Data_sanitation_2020)
