...
#GDP per capital
Data_GDP <- select(Data_sanitation, Country, SC_2000, SC_2020, GDPcapital2000, GDPcapital2020, Dummy0, Dummy1)
...
ggsave(path = NULL, file = "GDP_sanitation_safe_20230801.svg", plot = plot, dpi = 600, width = 4, height = 3.2)
...
#urbanization rate
Data_UP <- select(Data_sanitation, Country, SC_2000, SC_2020, UP2000, UP2020, Dummy0, Dummy1)
...
ggsave(path = NULL, file = "UP_sanitation_safe_20230801.svg", plot = plot_UP, dpi = 600, width = 4, height = 3.2)
...
#demogracy index
Data_di <- select(Data_sanitation, Country, SC_2000, SC_2020, DI2006, DI2020, Dummy0, Dummy1)
...
ggsave(path = NULL, file = "di_sanitation_safe_20230801.svg", plot = plot_di, dpi = 600, width = 4, height = 3.2)
...
Data_RW <- select(Data_sanitation, Country, SC_2000, SC_2020, RW2000, RW2020, Dummy0, Dummy1)
...
ggsave(path = NULL, file = "RW_sanitation_safe_20230801.svg", plot = plot_RW, dpi = 600, width = 4, height = 3.2)
